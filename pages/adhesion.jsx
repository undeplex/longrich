  ...
  return (
    <Layout>
        <div className="max-w-5xl mx-auto overflow-hidden px-3">
            <h1 className="play text-4xl">
                Deviens partenaires Step By Step
            </h1>
            ...
            <h1 className="play grid place-content-center text-center -[300px] text-3xl">
                Contacter Nous pour en apprendre plus
            </h1>


           <Stable>
            <span className="text-xl text-gray-600 mt-4">
                Apart les details donnes sur ce site , Longrich offres bien plus que vous ne pensez
                comme par exemple des incentives de voyages payer ,comme vous offrir une voiture et plus encore a decouvrir le 
                long de votre journey avec ce dernier
            </span>
           </Stable>
