    ...
    if (id) {
      const fetchProduct = async () => {
        try {
          ...
          const singleProduct = response.data.find((p) => p.id === parseInt(id));
...
<div className=" flex  lg:flex-row md:flex-row flex-col lg:gap-16  md:gap-10">
           <div className="bg-red-00">
                ...
                <div className="flex items-center  ">
                    ...
                    <a href="/product" className="">{product?.category}</a>
                 ...
                 {/* <img className="mx-auto lg:w-[395px] block  md:w-[470px] w-[214px] py-3" src={`/uploads/${product?.image}`} alt={product?.name} width="400" /> */}
                 <img className="mx-auto lg:w-[395px] block  md:w-[470px] w-[214px] py-3" src={`/uploads/${product?.image}`} alt={product?.name} width="400" />
</div>
